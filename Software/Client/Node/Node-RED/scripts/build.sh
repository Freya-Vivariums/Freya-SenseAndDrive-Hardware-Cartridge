...
#   directory, so nothing needs to be copied or rewritten here: package.json
#   already points node-red.nodes at build/, and npm picks up package.json,
#   README and LICENSE by itself.
##
