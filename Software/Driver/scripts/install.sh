...
#
#   This driver has no reboot-requiring step today, so it does not return 2 -
#   but the parent installer treats all three codes as the shared contract.
#
...
#   Freya-SenseAndDrive-Hardware-Cartridge. REPONAME below must match the repository, and
...
REPONAME=Freya-SenseAndDrive-Hardware-Cartridge
...
# tooling and the SDK's TypeScript types off the device.
